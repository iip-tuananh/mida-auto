...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('thanh-toan/{id}.html','CartController@checkoutluon')->name('checkoutluon');
    ...
    Route::get('{danhmuc}/{loaidanhmuc}.html','ProductController@allListType')->name('allListProType');
