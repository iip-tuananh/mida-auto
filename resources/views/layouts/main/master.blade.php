...
<html lang="vi">
   <head>
      ...
      <meta property="og:image:alt" content="midaviet" />
   ...
   <body id="body_m" >
      <div class="page-body">
         ...
         <script src="{{asset('frontend/js/cash.min.js')}}" defer></script>
         <!-- <script src="/js/mew_service.js" defer></script> -->
         ...
         <script src="{{asset('frontend/js/mew_noti.js')}}" defer></script>
         <script>
            window.cartStrings = {
