            ...
            <div class="b_product">
               <div class="mew_video swiper-container position-relative">
                  <div class="swiper-wrapper">
                     ...
                     @php
                         $imgser = jsond_decode($service->image);
                     @endphp
                        <div class="swiper-slide">
                        <div class="item_grid mb-3">
                           <div class="img_thm position-relative bor-10 modal-open">
                              <a href="{{route('serviceDetail', ['slug'=>$service->slug])}}" class="effect-ming open_video" title="{{$service->name}}">
                                    ...
                                    <img src="{{$imgser[0]}}" class="d-block img img-cover position-absolute lazy" alt="{{$service->name}}">
                                    <div class="position-absolute w-100 h-100 video_open lazy_bg" data-background="url({{$imgser[0]}})"></div>
                                    </div>
                              </a>
