...
@endsection
@section('content')
<section class="bread-crumb" style="background-image: linear-gradient(to bottom, rgb(10 9 9 / 44%) 0%,rgb(10 10 10 / 60%) 100%), url({{$detail_service->image}});">
	...
	<div class="rows">
		<div class="col-xs-12 a-left">
			...
			<ul class="breadcrumb" >
				...
				<li >
				<a  href="{{route('listServiceCate',['cate'=>$detail_service->category_slug])}}"><span >{{languageName($detail_service->cate->name)}}</span></a>	
				<span class="mr_lr">&nbsp;<i class="fa fa-angle-right"></i>&nbsp;</span>
				</li>
	...
	<div class="wrap_background_aside padding-top-0 margin-bottom-40 clearfix">
		<article class="article-main">
			<div class="row">
						...
						<div class="splide__track" style="height: 600px">
								<ul class="splide__list">
									...
									<li class="splide__slide">
										<img src="{{ $img }}" alt="" style="height: 100%" data-fancybox="gallery">
									</li>
									@endforeach
								</ul>
						</div>
				...
				<div class="col-md-5">
					<div class="article-details clearfix">
						<h2 class="clearfix text-uppercase" style="font-weight:600">Dịch vụ {{($detail_service->name)}}</h2>
			...
			<div class="row mt-5">
				...
				<div class="article-details clearfix">
					<h2 class="clearfix text-uppercase" style="font-weight:600">{{($detail_service->name)}}</h2>
					<div class="article-content clearfix">
						<div class="rte">
				...
				<div class="section bloglq clearfix">
					<h2>
						<a href="#" title="Tin liên quan">Dịch vụ liên quan</a>
					</h2>
