...
<div class="section wrap_background">
   <section class="bread-crumb" style="background-image: linear-gradient(to bottom, rgb(10 9 9 / 44%) 0%,rgb(10 10 10 / 60%) 100%), url({{isset($cateno) ? $cateno->avatar : $banners[0]->image}});background-attachment: fixed;">
                           ...
                           <ul class="nav navbar-pills">
                              ...
                              <li class="nav-item">
                                 ...
                                 <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                       <a class="nav-link" href="{{route('listServiceCate', ['cate'=>$category->slug])}}">{{languageName($category->name)}}
                                       </a>
                                    </li>
                                    @endforeach
                                 </ul>
