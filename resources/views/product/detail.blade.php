...
@endsection
@section('content')
<section class="bread-crumb" style="background-image: linear-gradient(to bottom, rgb(10 9 9 / 44%) 0%,rgb(10 10 10 / 60%) 100%), url({{$banners[0]->image}});background-attachment: fixed;">
                     ...
                     <div class="product-detail-left product-images col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="wrapbb clearfix">
                           <div class="col_large_default large-image">
                              <a  href="{{$imgs[0]}}" data-fancybox="gallery" >
                              ...
                              <div class="hidden">
                                 ...
                                 @if ($key != 0)
                                 <div class="item">
                                    <a href="{{$img}}" title="{{languageName($product->name)}}" data-image="{{$img}}" data-fancybox="gallery">	
                                    </a>
                                 </div>
                                 @endif
                                 @endforeach
                     ...
                     <div class="col-12 col-sm-12 col-md-6 col-lg-6 details-pro">
                        ...
                        <div class="fw w_100 clearfix" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                           ...
                           <div class="product-summary clearfix">
                              ...
                              <div class="tskt">
                                 <h4><i class="fas fa-info-circle"></i><span class="ml-2">Thông số kĩ thuật</span></h4>
                                 <table>
                                    <tbody>
                           ...
                           <div class="form-group form_button_details margin-top-15 clearfix">
                              <div class="form_product_content type1 ">
                                 <div class="button_actions clearfix">
                                    <a href="tel:{{$setting->phone1}}" type="submit" class="btn fast btn-main btn_base buy-now">
