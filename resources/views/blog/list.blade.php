...
@endsection
@section('content')
<section class="bread-crumb" style="background-image: linear-gradient(to bottom, rgb(10 9 9 / 44%) 0%,rgb(10 10 10 / 60%) 100%), url({{isset($cate) ? $cate->image : $banners[0]->image}});background-attachment: fixed;">
